...
/*
to do
clean up, better document, and think through the logic on this
I remember this logic being kind of a pain to use
 */
...
public class LevelLoad : MonoBehaviour
{
	...
	string currentLevelPath = "FoundationModelMapGenerator";
